...
public class SmoothCheckBox extends View implements Checkable {
	...
	private static final int COLOR_CHECKED = Color.parseColor("#447eeb");
	...
	private int mWidth, mHeight, mAnimDuration, mStrokeWidth;
	...
	private void drawCenter(Canvas canvas) {
		...
		// canvas.drawRect(0, 0, mWidth, mHeight, mFloorPaint);
	}
