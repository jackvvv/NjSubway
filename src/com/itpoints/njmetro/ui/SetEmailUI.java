 ...
 * 
 */
public class SetEmailUI extends BaseUI {
	...
	protected void findView_AddListener() {
		et_content = (EditText) findViewById(R.id.et_set_email_content);
	...
	protected void prepareData() {
		...
		content = MyApplication.userBean.getInfo().get("attrib32");
	...
	private void chgProfile() {
		...
		HttpUtil.post(this, url, params, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				if (HttpUtil.checkHttpSuccess(SetEmailUI.this, returnBean.getCode())) {
					// 修改成功
					MyApplication.userBean.getInfo().put("attrib32", content);
					back();
